...
- `[consensus]` guard the prevote/precommit delay metrics against a missing
  validator or proposer lookup in the current validator set
  ([\#39](https://github.com/mocachain/moca-cometbft/pull/39))
